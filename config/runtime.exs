...
#
#     PHX_SERVER=true bin/markmurphydev start
#
...
if config_env() == :prod do
  ...
  config :markmurphydev, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :markmurphydev, Markmurphydev.Mailer,
